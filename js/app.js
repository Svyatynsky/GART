 ...
 */
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        tippy_esm(".tooltip-trigger", {
            content: tooltipMap.innerHTML,
            allowHTML: true,
            arrow: true,
            animation: "scale",
            interactive: true,
        ...
        const targetNode = document.querySelector(".tooltip-trigger-wrapper");
        const config = {
            attributes: true,
            childList: true,
            subtree: true
        ...
        const callback = function(mutationsList, observer) {
            for (let mutation of mutationsList) if ("childList" === mutation.type) for (let addedNode of mutation.addedNodes) if (addedNode.hasAttribute("data-tippy-root")) document.body.appendChild(addedNode);
        };
        ...
        function initSliders() {
            if (window.matchMedia("(max-width: 767.98px)").matches) {
                if (document.querySelector(".column-stage__slider-1")) new core(".column-stage__slider-1", {
                    modules: [ Navigation ],
                    breakpoints: {
                        479.98: {
                        ...
                        320: {
                            slidesPerView: 1.11111,
                            spaceBetween: 15
                        }
                    }
                });
                if (document.querySelector(".column-stage__slider-2")) new core(".column-stage__slider-2", {
                    modules: [ Navigation ],
                    breakpoints: {
                        479.98: {
                            slidesPerView: 1.33333,
            ...
            if (document.querySelector(".variants-price__slider")) new core(".variants-price__slider", {
                modules: [ Navigation ],
                watchOverflow: true,
                breakpoints: {
                    991.98: {
